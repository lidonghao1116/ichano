...
public final class Blowfish {
	 ...
	 * @return
	 */
	public synchronized byte[] encrypt(String content) {
		int lens = content.getBytes(Charset.forName("utf-8")).length;
		int len8;
		int appendBlankCount = 0;
		if ((lens % 8) != 0) {
			len8 = ((lens + 7) / 8) * 8;
		...
		String appendBlank = StringUtils.repeat(" ", appendBlankCount);
		String encryptString = content.concat(appendBlank);
		byte[] enc_in = encryptString.getBytes(Charset.forName("utf-8"));
		byte[] enc_out = new byte[len8];
		encrypt(enc_in, 0, enc_out, 0, len8);
		return enc_out;

	}
	
	public synchronized byte[] encrypt(byte[] content){
...
//		String appendBlank = StringUtils.repeat(" ", appendBlankCount);
//		String encryptString = content.concat(appendBlank);
		byte[] enc_in = ByteUtils.append(content, (byte)0x20, appendBlankCount);
		byte[] enc_out = new byte[len8];
		encrypt(enc_in, 0, enc_out, 0, len8);
		return enc_out;
	}
	...
	public void encrypt(int xL, int xR, int[] out) {
		...
		out[0] = (int) (Xl & 0x00000000ffffffff);
		out[1] = (int) (Xr & 0x00000000ffffffff);

		/*
		 * ================================== // This also works as above. It is
		 * a short version of the part below long L, R;
		 * 
		 * L = xL; R = xR;
		 * 
		 * L ^= P[0]; R ^= ((((S0[(int)((L >>> 24) & 0xff)] + S1[(int)((L >>>
		 * 16) & 0xff)]) ^ S2[(int)((L >>> 8) & 0xff)]) + S3[(int)(L & 0xff)]) ^
		 * P[1]); L ^= ((((S0[(int)((R >>> 24) & 0xff)] + S1[(int)((R >>> 16) &
		 * 0xff)]) ^ S2[(int)((R >>> 8) & 0xff)]) + S3[(int)(R & 0xff)]) ^
		 * P[2]); R ^= P[3];
		 * 
		 * out[0] = (int) R; out[1] = (int) L;
		 * ============================================
		 */

		/*
		 * ===================================== // This is for N = 16 cases.
		 * long L, R;
		 * 
		 * L = xL; R = xR;
		 * 
		 ...
		 * P[1]); L ^= ((((S0[(int)((R >>> 24) & 0xff)] + S1[(int)((R >>> 16) &
		 * 0xff)]) ^ S2[(int)((R >>> 8) & 0xff)]) + S3[(int)(R & 0xff)]) ^
		 * P[2]); R ^= ((((S0[(int)((L >>> 24) & 0xff)] + S1[(int)((L >>> 16) &
		 * 0xff)]) ^ S2[(int)((L >>> 8) & 0xff)]) + S3[(int)(L & 0xff)]) ^
		 * P[3]); L ^= ((((S0[(int)((R >>> 24) & 0xff)] + S1[(int)((R >>> 16) &
		 * 0xff)]) ^ S2[(int)((R >>> 8) & 0xff)]) + S3[(int)(R & 0xff)]) ^
		 * P[4]);
		 * 
		 * R ^= ((((S0[(int)((L >>> 24) & 0xff)] + S1[(int)((L >>> 16) & 0xff)])
		 * ^ S2[(int)((L >>> 8) & 0xff)]) + S3[(int)(L & 0xff)]) ^ P[5]); L ^=
		 * ((((S0[(int)((R >>> 24) & 0xff)] + S1[(int)((R >>> 16) & 0xff)]) ^
		 * S2[(int)((R >>> 8) & 0xff)]) + S3[(int)(R & 0xff)]) ^ P[6]); R ^=
		 * ((((S0[(int)((L >>> 24) & 0xff)] + S1[(int)((L >>> 16) & 0xff)]) ^
		 * S2[(int)((L >>> 8) & 0xff)]) + S3[(int)(L & 0xff)]) ^ P[7]); L ^=
		 * ((((S0[(int)((R >>> 24) & 0xff)] + S1[(int)((R >>> 16) & 0xff)]) ^
		 * S2[(int)((R >>> 8) & 0xff)]) + S3[(int)(R & 0xff)]) ^ P[8]); R ^=
		 * ((((S0[(int)((L >>> 24) & 0xff)] + S1[(int)((L >>> 16) & 0xff)]) ^
		 * S2[(int)((L >>> 8) & 0xff)]) + S3[(int)(L & 0xff)]) ^ P[9]); L ^=
		 * ((((S0[(int)((R >>> 24) & 0xff)] + S1[(int)((R >>> 16) & 0xff)]) ^
		 * S2[(int)((R >>> 8) & 0xff)]) + S3[(int)(R & 0xff)]) ^ P[10]); R ^=
		 * ((((S0[(int)((L >>> 24) & 0xff)] + S1[(int)((L >>> 16) & 0xff)]) ^
		 * S2[(int)((L >>> 8) & 0xff)]) + S3[(int)(L & 0xff)]) ^ P[11]); L ^=
		 * ((((S0[(int)((R >>> 24) & 0xff)] + S1[(int)((R >>> 16) & 0xff)]) ^
		 * S2[(int)((R >>> 8) & 0xff)]) + S3[(int)(R & 0xff)]) ^ P[12]); R ^=
		 * ((((S0[(int)((L >>> 24) & 0xff)] + S1[(int)((L >>> 16) & 0xff)]) ^
		 * S2[(int)((L >>> 8) & 0xff)]) + S3[(int)(L & 0xff)]) ^ P[13]); L ^=
		 * ((((S0[(int)((R >>> 24) & 0xff)] + S1[(int)((R >>> 16) & 0xff)]) ^
		 * S2[(int)((R >>> 8) & 0xff)]) + S3[(int)(R & 0xff)]) ^ P[14]); R ^=
		 * ((((S0[(int)((L >>> 24) & 0xff)] + S1[(int)((L >>> 16) & 0xff)]) ^
		 * S2[(int)((L >>> 8) & 0xff)]) + S3[(int)(L & 0xff)]) ^ P[15]); L ^=
		 * ((((S0[(int)((R >>> 24) & 0xff)] + S1[(int)((R >>> 16) & 0xff)]) ^
		 * S2[(int)((R >>> 8) & 0xff)]) + S3[(int)(R & 0xff)]) ^ P[16]); R ^=
		 * P[17];
		 * 
		 * out[0] = R; out[1] = L;
		 * ==============================================
	...
	public synchronized void decrypt(byte[] src, int srcOff, byte[] dest,
		...
		for (int si = srcOff, di = destOff; si < end; si += 8, di += 8) {
			d0 = ((src[si + 3] & 0xff) | ((src[si + 2] & 0xff) << 8)
					| ((src[si + 1] & 0xff) << 16) | ((src[si] & 0xff) << 24));
			d1 = ((src[si + 7] & 0xff) | ((src[si + 6] & 0xff) << 8)
					| ((src[si + 5] & 0xff) << 16) | ((src[si + 4] & 0xff) << 24));
			decrypt(d0, d1, out);
			iv0 = out[0];
			iv1 = out[1];
	...
	public int[] decrypt(int xL, int xR, int[] out) {
		 ...
		 * L = xL; R = xR;
		 * 
		 * L ^= P[17]; R ^= ((((S0[(int)((L >>> 24) & 0xff)] + S1[(int)((L >>>
		 * 16) & 0xff)]) ^ S2[(int)((L >>> 8) & 0xff)]) + S3[(int)(L & 0xff)]) ^
		 * P[16]); L ^= ((((S0[(int)((R >>> 24) & 0xff)] + S1[(int)((R >>> 16) &
		 * 0xff)]) ^ S2[(int)((R >>> 8) & 0xff)]) + S3[(int)(R & 0xff)]) ^
		 * P[15]); R ^= ((((S0[(int)((L >>> 24) & 0xff)] + S1[(int)((L >>> 16) &
		 * 0xff)]) ^ S2[(int)((L >>> 8) & 0xff)]) + S3[(int)(L & 0xff)]) ^
		 * P[14]); L ^= ((((S0[(int)((R >>> 24) & 0xff)] + S1[(int)((R >>> 16) &
		 * 0xff)]) ^ S2[(int)((R >>> 8) & 0xff)]) + S3[(int)(R & 0xff)]) ^
		 * P[13]); R ^= ((((S0[(int)((L >>> 24) & 0xff)] + S1[(int)((L >>> 16) &
		 * 0xff)]) ^ S2[(int)((L >>> 8) & 0xff)]) + S3[(int)(L & 0xff)]) ^
		 * P[12]); L ^= ((((S0[(int)((R >>> 24) & 0xff)] + S1[(int)((R >>> 16) &
		 * 0xff)]) ^ S2[(int)((R >>> 8) & 0xff)]) + S3[(int)(R & 0xff)]) ^
		 * P[11]); R ^= ((((S0[(int)((L >>> 24) & 0xff)] + S1[(int)((L >>> 16) &
		 * 0xff)]) ^ S2[(int)((L >>> 8) & 0xff)]) + S3[(int)(L & 0xff)]) ^
		 * P[10]); L ^= ((((S0[(int)((R >>> 24) & 0xff)] + S1[(int)((R >>> 16) &
		 * 0xff)]) ^ S2[(int)((R >>> 8) & 0xff)]) + S3[(int)(R & 0xff)]) ^
		 * P[9]); R ^= ((((S0[(int)((L >>> 24) & 0xff)] + S1[(int)((L >>> 16) &
		 * 0xff)]) ^ S2[(int)((L >>> 8) & 0xff)]) + S3[(int)(L & 0xff)]) ^
		 * P[8]); L ^= ((((S0[(int)((R >>> 24) & 0xff)] + S1[(int)((R >>> 16) &
		 * 0xff)]) ^ S2[(int)((R >>> 8) & 0xff)]) + S3[(int)(R & 0xff)]) ^
		 * P[7]); R ^= ((((S0[(int)((L >>> 24) & 0xff)] + S1[(int)((L >>> 16) &
		 * 0xff)]) ^ S2[(int)((L >>> 8) & 0xff)]) + S3[(int)(L & 0xff)]) ^
		 * P[6]); L ^= ((((S0[(int)((R >>> 24) & 0xff)] + S1[(int)((R >>> 16) &
		 * 0xff)]) ^ S2[(int)((R >>> 8) & 0xff)]) + S3[(int)(R & 0xff)]) ^
		 * P[5]); R ^= ((((S0[(int)((L >>> 24) & 0xff)] + S1[(int)((L >>> 16) &
		 * 0xff)]) ^ S2[(int)((L >>> 8) & 0xff)]) + S3[(int)(L & 0xff)]) ^
		 * P[4]); L ^= ((((S0[(int)((R >>> 24) & 0xff)] + S1[(int)((R >>> 16) &
		 * 0xff)]) ^ S2[(int)((R >>> 8) & 0xff)]) + S3[(int)(R & 0xff)]) ^
		 * P[3]); R ^= ((((S0[(int)((L >>> 24) & 0xff)] + S1[(int)((L >>> 16) &
		 * 0xff)]) ^ S2[(int)((L >>> 8) & 0xff)]) + S3[(int)(L & 0xff)]) ^
		 * P[2]); L ^= ((((S0[(int)((R >>> 24) & 0xff)] + S1[(int)((R >>> 16) &
		 * 0xff)]) ^ S2[(int)((R >>> 8) & 0xff)]) + S3[(int)(R & 0xff)]) ^
		 * P[1]); R ^= P[0];
		 * 
		 * out[0] = R; out[1] = L;
