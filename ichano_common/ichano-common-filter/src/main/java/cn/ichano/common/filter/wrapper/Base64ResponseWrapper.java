...
import cn.ichano.common.filter.wrapper.BlowfishResponseWrapper.WrappedOutputStream;
...
public class Base64ResponseWrapper  extends HttpServletResponseWrapper {
	...
	public Base64ResponseWrapper(HttpServletResponse resp) throws IOException {
		super(resp);
